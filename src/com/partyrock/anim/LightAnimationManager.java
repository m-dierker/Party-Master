...
/**
 * Manages the master list of all animations. When you make an animation, you
 * need to add it here.
 * @author Matthew
 * 
 */
public class LightAnimationManager {
	...
	/**
	 * This is used in menus to return a list of all animations that will work
	 * on *all* of the given elements
	 * So if two lasers and three strands of lights are selected, this will only
	 * return Animations that work with *both* of those things and can take in a
	 * combination of both of them
	 * @param elements The elements to check
	 * @return A list of animation classes that can support the entirely of the
	 *         incoming elements
	 */
	...
	public ArrayList<Class<? extends ElementAnimation>> getAnimationListForElements(
		...
		for (Class<? extends ElementAnimation> c : getAnimationList()) {
			try {
				EnumSet<ElementType> supportedTypes = (EnumSet<ElementType>) c.getMethod("getSupportedTypes").invoke(null);
